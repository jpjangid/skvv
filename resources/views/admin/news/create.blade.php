                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('heading') is-invalid @enderror" name="heading" value="{{ old('heading') }}" placeholder="Please enter heading">
                                    @error('heading')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control datepicker @error('display_date') is-invalid @enderror" name="display_date" placeholder="Select date" type="text" value="{{ date('Y-m-d') }}">
                                        @error('display_date')
                                            <span class="error invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control datepicker @error('last_date') is-invalid @enderror" name="last_date"  placeholder="Select date" type="text" value="{{ date('Y-m-d') }}">
                                        @error('last_date')
                                            <span class="error invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
