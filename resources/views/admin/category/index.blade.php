    ...
    <div class="col-lg-6 col-7">
      ...
      <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
          ...
          <li class="breadcrumb-item active" aria-current="{{ url('admin/category') }}">Category</li>
        </ol>
      </nav>
    </div>
    <div class="col-lg-6 col-5 text-right">
      <a href="{{ route('category.create')}}" class="btn btn-neutral">+ Add Category</a>
    </div>
  </div>
@endsection
                        ...
                        <div>
                            <table class="table align-items-center myTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $i }}</td>
                                        @if(!empty($category->college_id))
                                        <td>{{ $category->college->name }}</td>
                                        @else
                                        <td><i>N/A</i></td>
                                        @endif
                                        <td>{{ $category->name }}</td>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    ...
                                                    <a class="dropdown-item" href="#" onclick="deleteData({{ $category->id }})" data-toggle="modal" data-target="#modal-sm">Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>This process can not be undone. Are you sure you want to delete this Category?</p>
                                </div>
                                @endif
