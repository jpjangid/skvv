                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="designation" placeholder="Please enter Designation" value="{{ $user->designation }}" />
                                @error('designation')
                                <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
