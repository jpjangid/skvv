...
@section('breadcrumb')
  <div class="row align-items-center py-4">
    <div class="col-lg-6 col-7">
      <h6 class="h2 text-white d-inline-block mb-0">Edit Role Permissions</h6>
      <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
          <li class="breadcrumb-item"><a href="#"><i class="fas fa-home"></i></a></li>
          <li class="breadcrumb-item"><a href="#">Dashboards</a></li>
          <li class="breadcrumb-item"><a href="{{ route('users.index')}}">Role Permissions</a></li>
          <li class="breadcrumb-item active" aria-current="page">Edit Role Permissions</li>
        </ol>
      </nav>
    </div>
  </div>
    ...
    <div class="container-fluid mt--6">
        ...
        <div class="row">
            <div class="col-xl-12 col-md-12" style="background-color:white; border-radius:5px;">
                <!-- form start -->
                <form class="form" action="{{ url('admin/rolepermissions/update',$id) }}" method="post">
                @method('PUT')
                @csrf
                <div class="card-body">
...
<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
    <script>
        $('.permission_id').on('change', function(){
            ...
            $.ajax({
                url:"{{url('admin/rolepermissions/store')}}",
                type: "POST",
                data: {
