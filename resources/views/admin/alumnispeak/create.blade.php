    ...
    <div class="container-fluid mt--6">
        ...
        <div class="row">
            <div class="col-xl-12 col-md-12" style="background-color:white; border-radius:5px;">
                <!-- form start -->
                <form action="{{ route('alumnispeak.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <!-- Slug Name -->
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="" placeholder="Please Enter Name" value="{{ old('name') }}">
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('designation') is-invalid @enderror" name="designation" id="" placeholder="Please Enter Designation" value="{{ old('designation') }}">
                                    @error('designation')
                                        <span class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" rows="3" name="description" id="Description" placeholder="Please Enter Description">{{ old('description') }}</textarea>
                                </div>
                            </div>    
                             <!-- alumni Image -->
                             <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" accept="image/*" name="alumni_image" id="alumni_image" placeholder="Please Enter  image" value="{{ old('alumni_image') }}">
                                    @error('alumni_image')
                                        <span class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
