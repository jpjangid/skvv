                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control custom-select" name="addmission" id="addmission" value="{{ old('addmission')}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="addmission_year" id="addmission_year" value="{{ old('addmission_year')}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('adhaar_no') is-invalid @enderror" id="adhaar_no" name="adhaar_no" placeholder="Please Enter Aadhaar No" value="{{ old('student_father_name') }}">
                                @error('adhaar_no')
                                <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nationalilty') is-invalid @enderror" id="nationalilty" name="nationalilty" placeholder="Please Enter Nationality" value="{{ old('student_father_name') }}">
                                @error('nationalilty')
                                <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control custom-select" name="caste" id="caste" value="{{ old('caste')}}">
                            ...
                            <table id="item_tableroom" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td rowspan="2"><input type="number" class="form-control" name="passing_year[]" id="passing_year" placeholder=""></td>
                                        ...
                                        <td><input type="number" class="form-control" name="percentage[]" id="percentage" placeholder=""></td>
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.addroom', function() {
                ...
                html += '<td><input type="number" name="passing_year[]" id="passing_year" class="form-control passing_year" placeholder="" /></td>';
                ...
                html += '<td><input type="number" name="percentage[]" id="amount" class="form-control percentage" placeholder="" /></td>';
