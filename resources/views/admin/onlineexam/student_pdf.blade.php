    ...
    <table>
        <tbody>
            <tr>
                ...
                @if(!empty($OnlineExam->signature))
                <td colspan="11" class="tlr"> <img src="{{ public_path('storage/onlineexam/'.$OnlineExam->signature) }}" style="height: 100px;width: 100px;margin-top: 0px; margin-left:50px; object-fit:cover"></td>
                @else
                <td colspan="11" class="tlr"></td>
                @endif
            </tr>
        </tbody>
    </table>
