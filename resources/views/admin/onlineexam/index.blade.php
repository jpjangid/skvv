                            ...
                            <table class="table align-items-center myTable">
                                ...
                                <tbody>
                                    @php 
                                        $i = 1;
                                    @endphp
                                    @foreach($onlinexams as $onlinexam)
                                        <tr>
                                            <td>{{ $i++}}</td>
                                            <td>{{ $onlinexam->subject}}</td>
                                            <td>{{ $onlinexam->student_name}}</td>
                                            <td>{{ $onlinexam->adhaar_no}}</td>
                                            <td>{{ $onlinexam->stud_father_name}}</td>
                                            <td>{{ $onlinexam->email}}</td>
                                            <td>{{ $onlinexam->mobile_no}}</td>
                                            <td>{{ $onlinexam->gender}}</td>
                                            <td>{{ $onlinexam->payment_type}}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
