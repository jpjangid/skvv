                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="qualifications" value="{{ $faculty->qualifications }}" class="form-control @error('qualifications') is-invalid @enderror" placeholder="Please Enter Qualifications">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="specializations" value="{{ $faculty->specializations }}" class="form-control @error('specializations') is-invalid @enderror" placeholder="Please Enter Specializations">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="research_interests" value="{{ $faculty->research_interests }}" class="form-control @error('research_interests') is-invalid @enderror" placeholder="Please Enter Research Interests">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="published_books" value="{{ $faculty->published_books }}" class="form-control @error('published_books') is-invalid @enderror" placeholder="Please Enter Published Books Number">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="office_address" value="{{ $faculty->office_address }}" class="form-control @error('office_address') is-invalid @enderror" placeholder="Please Enter Office Address">{{ $faculty->office_address }}</textarea>
